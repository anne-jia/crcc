...
var textField = function(options, defaultParameters) {
  ...
  var executeValueChange = function(element, inputNode) {
    return true;
  };
  ...
  resource.html =
    ...
    '<div class="bpp-field-wrapper" ' +
      ...
      '</button>' +
      '<button style="display:none" data-action="executeValueChange"></button>' +
    '</div>';
  ...
  resource['executeValueChange'] = executeValueChange;
